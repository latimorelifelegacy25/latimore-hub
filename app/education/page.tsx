...
const blogPosts = [
  {
    title: 'What Living Benefits Actually Do for Families',
    slug: '/education/blog/what-living-benefits-actually-do-for-families',
    excerpt:
      'A plain-English breakdown of how living benefit riders can help during chronic, critical, or terminal illness.',
    category: 'Life Insurance',
    readTime: '4 min read',
  },
  {
    title: 'Term vs. IUL: Which One Fits Your Stage of Life?',
    slug: '/education/blog/term-vs-iul-which-one-fits-your-stage-of-life',
    excerpt:
      'Compare temporary protection and long-term permanent strategies without the sales noise.',
    category: 'Protection Strategy',
    readTime: '5 min read',
  },
  {
    title: 'How Fixed Indexed Annuities Help Protect Retirement Income',
    slug: '/education/blog/how-fixed-indexed-annuities-help-protect-retirement-income',
    excerpt:
      'See how principal protection, indexed growth potential, and lifetime income fit into a retirement plan.',
    category: 'Retirement',
    readTime: '6 min read',
  },
]
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px' }}>
        ...
        >
          ...
          >
            ...
            Independent contractor affiliated with Global Financial Impact. For
...
Without it, your family absorbs every financial obligation you leave behind. With it, they have time to grieve without financial pressure. Life insurance is not about death — it is about protecting the life your family would need to rebuild.`,
    callout:
      'Key fact: The death benefit is generally income-tax-free to your beneficiary.',
  },
  {
    icon: <Clock size={28} />,
...
Permanent insurance (whole life or universal life) never expires as long as premiums are paid. It also builds cash value over time — a living asset you can borrow against. Permanent coverage costs more but provides lifelong protection and can serve as a financial planning tool.`,
    callout:
      'The right choice depends on your age, income, health, and long-term goals — not a one-size formula.',
  },
  {
...
Annuities are not market investments. They are insurance products designed to protect your principal while providing growth and income you cannot outlive. They are particularly valuable for rolling over 401(k)s, pensions, or other retirement funds into a protected vehicle.`,
    callout:
      'Fixed and fixed-indexed annuities offer principal protection — your balance cannot go negative due to market losses.',
  },
  {
    icon: '',
...
Done correctly, a rollover is tax-free and penalty-free. Done incorrectly — or left sitting in a former employer's plan where you have no control — it can cost you in fees, poor investment options, or tax consequences you did not anticipate. A rollover consultation can save you thousands.`,
    callout:
      'You typically have 60 days from receiving a distribution to complete a rollover without penalty.',
  },
  {
    icon: '',
...
For small businesses, the loss of one key person can be fatal to operations. This coverage buys the business time to survive and recover.`,
    callout:
      'Any business that would suffer a serious financial loss from losing one individual should consider key person coverage.',
  },
  {
    icon: '',
...
Unlike private mortgage insurance (PMI), which protects the lender, mortgage protection insurance protects your family. It is one of the most straightforward and impactful policies a homeowner can have.`,
    callout:
      'Mortgage protection is typically structured as a decreasing term policy that mirrors your mortgage balance.',
  },
  {
    icon: '',
...
Unlike 529 plans, there are no restrictions on how you use the funds. And unlike savings accounts, the cash value is protected from market downturns and may not count against financial aid eligibility the same way other assets do.`,
    callout:
      'This strategy works best when started early — the more time the cash value has to grow, the more powerful it becomes.',
  },
]
  ...
  return (
    <>
      ...
      <main style={{ fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>
        ...
        >
          <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 20px' }}>
            ...
            >
              ...
              <br />
              <span style={{ color: goldLight }}>Before You Buy It</span>
            </h1>
            ...
            >
              An educated client makes better decisions. These guides break down
              the most important concepts in plain language — no jargon, no sales
              pitch.
            </p>
          </div>
        </section>
        ...
        {/* Blog Section */}
        <section style={{ background: '#F8F6F1', padding: '4rem 0' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 20px' }}>
            <div style={{ maxWidth: 760, marginBottom: '2.5rem' }}>
              ...
              >
                Deeper Education for Smarter Protection Decisions
              </h2>

              <p style={{ color: '#4B5563', lineHeight: 1.8 }}>
                Practical articles designed to help families, pre-retirees, and
                business owners understand protection, accumulation, and legacy
        ...
        >
          <div style={{ maxWidth: 700, margin: '0 auto', padding: '0 20px' }}>
            ...
            >
              No obligation, no pressure. A 20-minute conversation can give you
              more clarity than hours of online research.
            </p>
